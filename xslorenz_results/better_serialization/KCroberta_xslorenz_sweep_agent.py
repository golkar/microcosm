...
os.environ["WANDB_NOTEBOOK_NAME"] = "KCroberta_xslorenz_sweep_agent.py"
wandb.login()
...
save_path = "/mnt/home/sgolkar/ceph/saves/xslorenz/KCroberta/"
...
from KCroberta import KC_mlm_collator, KCRobertaForMaskedLM
...
def train(config=None):
    ...
    with wandb.init(
        ...
        training_args = TrainingArguments(
            ...
            per_device_train_batch_size=wandb_config.batch_size_total // world_size,
            save_total_limit=2,
            logging_steps=200,
            report_to="wandb",
...
if __name__ == "__main__":
    ...
    if is_master:
        wandb.agent(
            ...
            train,
            count=args.count,
            project="xslorenz_kcroberta_shortbrack",
        )
    else:
        train(config={})
# %%
